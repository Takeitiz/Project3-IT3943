...
import { useGetAuthGigByIdQuery } from '../../auth/services/auth.service.ts';
import { ISellerGig } from '../../gigs/interfaces/gig.interface.ts';
import { emptyGigData } from '../../../shared/utils/static-data.ts';
import RegisterModal from '../../auth/components/Register.tsx';
import Header from '../../../shared/header/components/Header.tsx';
...
import HtmlParser from '../../../shared/html-parser/HtmlParser.tsx';
