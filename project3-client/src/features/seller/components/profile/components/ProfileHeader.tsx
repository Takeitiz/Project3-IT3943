...
import { IProfileHeaderProps, ISellerProfileItem, IShowEditItem } from '../../../interfaces/seller.interface.ts';
...
import { IGigInfo } from '../../../../gigs/interfaces/gig.interface.ts';
import { lowerCase, rating, shortenLargeNumbers } from '../../../../../shared/utils/utils.service.ts';
          ...
          <div className="flex w-full gap-x-1 self-center">
            ...
            {sellerProfile?.ratingSum && sellerProfile.ratingsCount ? (
              <div className="ml-2 mt-[3px] flex gap-1 rounded bg-orange-400 px-1 text-xs">
                <span
                  className="font-bold text-white">{rating(sellerProfile?.ratingSum / sellerProfile.ratingsCount)}</span>
              </div>
            ) : (
