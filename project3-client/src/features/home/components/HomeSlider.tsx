...
import { ISliderState } from '../interfaces/home.interface.ts';
import { sliderImages, sliderImagesText } from '../../../shared/utils/static-data.ts';
import { ISliderImagesText } from '../../../shared/shared.interface.ts';
