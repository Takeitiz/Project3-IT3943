...
import BuyerTable from './BuyerTable.tsx';
import { orderTypes, shortenLargeNumbers } from '../../../shared/utils/utils.service.ts';
...
import { useGetOrdersByBuyerIdQuery } from '../../order/services/order.service.ts';
