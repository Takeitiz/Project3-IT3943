...
import { IModalBgProps } from '../../../shared/modals/interfaces/modal.interfaces';
import Button from '../../../shared/button/Button';
import Alert from '../../../shared/alert/Alert';
import TextInput from '../../../shared/inputs/TextInput';
import { FaEye, FaEyeSlash, FaTimes } from 'react-icons/fa';
import ModalBg from '../../../shared/modals/ModalBg';
import { ISignInPayload } from '../interfaces/auth.interface.ts';
import { useAppDispatch } from '../../../store/store.ts';
import { loginUserSchema } from '../schemes/auth.schema.ts';
      ...
      <div className="relative top-[20%] mx-auto w-11/12 max-w-md rounded-lg bg-white md:w-2/3">
        <div className="relative px-5 py-5">
          <div className="mb-5 flex justify-between text-2xl font-bold text-gray-600">
            ...
            <Button testId="closeModal" className="cursor-pointer rounded text-gray-400 hover:text-gray-600"
                    role="button"
