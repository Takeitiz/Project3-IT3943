...
import { ISignInPayload, ISignUpPayload } from '../interfaces/auth.interface.ts';
...
export const authApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    checkCurrentUser: build.query<IResponse, string>({
      query: (userId) => `auth/currentuser/${userId}`,
