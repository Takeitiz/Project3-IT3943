...
import { checkFile, fileType, readAsBase64 } from '../../../../shared/utils/image-utils-service.ts';
...
const ChatWindow: FC<IChatWindowProps> = ({ chatMessages, isLoading}): ReactElement => {
  ...
  const { data: buyerData, isSuccess: isBuyerSuccess } = useGetBuyerByUsernameQuery(`${username}`);
