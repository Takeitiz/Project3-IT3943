...
import { IOffer, IOrderDocument, IOrderInvoice } from '../interfaces/order.interface.ts';
...
import { useGetGigByIdQuery } from '../../gigs/services/gigs.service.ts';
...
import { TimeAgo } from '../../../shared/utils/timeago.utils.ts';
        ...
        <div className="w-full p-4 lg:w-1/3">
          <div className="border-grey mb-8 border">
            <div className="mb-2 flex flex-col border-b md:flex-row">
              <img className="w-full object-cover" src={gigRef.current?.coverImage ?? placeholder}
                   alt="Gig Cover Image" />
            </div>
            <ul className="mb-0 list-none">
              ...
              <li className="flex justify-between px-4 pb-2 pt-4">
                ...
                <span
                  className="rounded bg-orange-300 px-[5px] py-[2px] text-xs font-bold uppercase text-white">incomplete</span>
              </li>
