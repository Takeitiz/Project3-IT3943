...
import { IOrderDocument } from '../interfaces/order.interface.ts';
import { useGetOrderByOrderIdQuery } from '../services/order.service.ts';
import { socket, socketService } from '../../../sockets/socket.service.ts';
import { TimeAgo } from '../../../shared/utils/timeago.utils.ts';
import DeliveryTimer from './DeliveryTimer.tsx';
import OrderDetailsTable from './OrderDetailsTable.tsx';
import OrderActivities from './order-activities/OrderActivities.tsx';
