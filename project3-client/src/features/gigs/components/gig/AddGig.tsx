...
import TextAreaInput from '../../../../shared/inputs/TextAreaInput.tsx';
...
import { GIG_MAX_LENGTH, IAllowedGigItem, ICreateGig, IShowGigModal } from '../../interfaces/gig.interface.ts';
import {
  categories,
  expectedGigDelivery, lowerCase,
  reactQuillUtils, replaceSpacesWithDash,
  showErrorToast
...
import { useGigSchema } from '../../hooks/useGigSchema.ts';
import { gigInfoSchema } from '../../schemes/gig.schema.ts';
import { NavigateFunction, useNavigate, useParams } from 'react-router-dom';
import { IApprovalModalContent } from '../../../../shared/modals/interfaces/modal.interfaces.ts';
import ApprovalModal from '../../../../shared/modals/ApprovalModal.tsx';
import { useCreateGigMutation } from '../../services/gigs.service.ts';
      ...
      <div className="relative w-screen">
        ...
        <div className="container relative mx-auto my-5 px-2 pb-12 md:px-0">
          ...
          {authUser && !authUser.emailVerified && (
            <div
              className="absolute left-0 top-0 z-[80] flex h-full w-full justify-center bg-white/[0.8] text-sm font-bold md:text-base lg:text-xl">
          ...
          <div className="border-grey left-0 top-0 z-10 mt-4 block rounded border bg-white p-6">
            <div className="mb-6 grid md:grid-cols-5">
              ...
              <div className="col-span-4 md:w-11/12 lg:w-8/12">
                ...
                />
                <span
                  className="flex justify-end text-xs text-[#95979d]">{allowedGigItemLength.gigTitle} Characters</span>
              </div>
            </div>
            <div className="mb-6 grid md:grid-cols-5">
              <div className="pb-2 text-base font-medium">
              ...
              <div className="col-span-4 md:w-11/12 lg:w-8/12">
                <TextInput
                  className="border-grey mb-1 w-full rounded border p-2.5 text-sm font-normal text-gray-600 focus:outline-none"
                  placeholder="Write what exactly you'll do in short." type="text" name="basicTitle"
                ...
                />
                <span
                  className="flex justify-end text-xs text-[#95979d]">{allowedGigItemLength.basicTitle} Characters</span>
              </div>
            </div>
            <div className="mb-6 grid md:grid-cols-5">
              <div className="pb-2 text-base font-medium">
              ...
              <div className="col-span-4 md:w-11/12 lg:w-8/12">
                <TextAreaInput
                  className="border-grey mb-1 w-full rounded border p-2.5 text-sm font-normal text-gray-600 focus:outline-none"
                  placeholder="Write a brief description..." name="basicDescription"
                ...
                />
                <span
                  className="flex justify-end text-xs text-[#95979d]">{allowedGigItemLength.basicDescription} Characters</span>
              </div>
            </div>
            <div className="mb-6 grid md:grid-cols-5">
              <div className="pb-2 text-base font-medium">
              ...
              <div className="col-span-4 md:w-11/12 lg:w-8/12">
                ...
                />
                <span
                  className="flex justify-end text-xs text-[#95979d]">{allowedGigItemLength.descriptionCharacters} Characters</span>
              </div>
            </div>
            ...
            <div className="mb-6 grid md:grid-cols-5">
              ...
              >
                {gigInfo.coverImage && (
                  <img src={gigInfo.coverImage} alt="Cover Image"
                       className="left-0 top-0 h-[220px] w-[320px] bg-white object-cover" />
                )}
                {!gigInfo.coverImage && (
                  <div
                    className="left-0 top-0 flex h-[220px] w-[320px] cursor-pointer justify-center bg-[#dee1e7]"></div>
                )}
                {showGigModal.image && (
                  <div
