...
import { lowerCase } from '../../utils/utils.service.ts';
import SettingsDropdown from './SettingsDropdown.tsx';
import { socket, socketService } from '../../../sockets/socket.service.ts';
import { find } from 'lodash';
import DashboardHeaderSideBar from './mobile/DashboardHeaderSideBar.tsx';
...
const DashboardHeader: FC = (): ReactElement => {
  ...
  return (
    <>
      ...
      <header>
        <nav
          className="navbar peer-checked:navbar-active relative z-20 w-full border-b bg-white shadow-2xl shadow-gray-600/5 backdrop-blur dark:shadow-none">
                ...
                <div className="text-[#74767e] lg:pr-4">
                  <ul className="flex text-base font-medium">
                    ...
                    <li className="relative flex cursor-pointer items-center">
                      ...
                      />
                      <Transition show={isDropdownOpen} enter="transition ease-out duration-200"
