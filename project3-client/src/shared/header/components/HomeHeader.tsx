...
import HeaderSearchInput from './HeaderSearchInput.tsx';
import MessageDropdown from './MessageDropdown.tsx';
import { socket, socketService } from '../../../sockets/socket.service.ts';
import { updateNotification } from '../reducers/notification.reducer.ts';
import { IMessageDocument } from '../../../features/chat/interfaces/chat.interface.ts';
import { IOrderNotifcation } from '../../../features/order/interfaces/order.interface.ts';
import HomeHeaderSideBar from './mobile/HomeHeaderSideBar.tsx';
import MobileHeaderSearchInput from './mobile/MobileHeaderSearchInput.tsx';
import { filter, find } from 'lodash';
import OrderDropdown from './OrderDropdown.tsx';
import NotificationDropdown from './NotificationDropdown.tsx';
import { useGetNotificationsByIdQuery } from '../../../features/order/services/notification.service.ts';
                ...
                <div className="text-[#74767e] lg:pr-4">
                  <ul className="flex text-base font-medium">
                    <li className="relative z-50 flex cursor-pointer items-center">
                      ...
                      >
                        <div className="absolute -right-20 mt-5 w-96">
                    ...
                    <li className="relative z-50 flex cursor-pointer items-center">
                      ...
                      <Transition
                        ...
                        leaveTo="opacity-0 translate-y-1"
                      >
                        <div className="absolute -right-40 mt-5 w-96">
                          <div className="absolute right-0 mt-5 w-96">
                    ...
                    <li className="relative z-50 flex cursor-pointer items-center">
                        ...
                        label={
                          <>
                            ...
                            {authUsername === authUser.username && (
                              <span
                                className="absolute bottom-0 left-8 h-2.5 w-2.5 rounded-full border-2 border-white bg-green-400"></span>
                            )}
                      ...
                      <Transition ref={settingsDropdownRef} show={isSettingsDropdown}
                        ...
                        <div className="absolute -right-43 z-50 mt-5 w-96">
                          <div className="absolute -right-0 z-50 mt-5 w-96">
                            <SettingsDropdown
                              seller={seller}
                              buyer={buyer}
                              authUser={authUser}
                ...
                <div ref={navElement}
                  ...
                  {categories().map((category: string) => (
                    <span key={uuidv4()} className="mx-4 cursor-pointer first:ml-0 hover:text-sky-400 lg:mx-0">
                        <Link to={`/categories/${replaceSpacesWithPlus(category)}`}>
                        {category}
                        </Link>
                    </span>
                  ))}
